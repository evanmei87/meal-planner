...
def apply_presets_to_week(week_days: list[dict], presets: dict) -> list[dict]:
    """
    ...
    Returns:
        The same list of day dicts. Days with no stored exercises are
        filled from presets[day["day_name"]] with new ids and freshly
        computed calories. Days that already have exercises are left
        untouched — a preset never overwrites real data.
    """
